        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-slate-600 dark:text-slate-300 max-w-2xl leading-relaxed font-sans">
              Practical insights, tutorials and ideas for developers building the modern web. From React 19 and Next.js App Router to distributed Node.js architectures and AI integration.
            </p>
            ...
            <div className="pt-6 flex items-center gap-6 sm:gap-10 border-t border-slate-200 dark:border-slate-800/60 text-xs font-mono text-slate-500 dark:text-slate-400">
              <div>
                <strong className="block text-base font-bold text-slate-900 dark:text-white">12+</strong>
                <span>Deep-Dive Guides</span>
              </div>
              <div className="h-7 w-px bg-slate-200 dark:bg-slate-800" />
              <div>
                <strong className="block text-base font-bold text-slate-900 dark:text-white">10+</strong>
                <span>Tech Categories</span>
              </div>
              <div className="h-7 w-px bg-slate-200 dark:bg-slate-800" />
              <div>
                <strong className="block text-base font-bold text-cyan-600 dark:text-cyan-400">0%</strong>
