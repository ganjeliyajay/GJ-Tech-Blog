        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-slate-900 dark:text-white font-sans">
              {t.categories.exploreByTechnology}
            </h2>
          </div>
          ...
          {allCategories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`relative px-4 py-2.5 rounded-xl text-xs sm:text-sm font-mono whitespace-nowrap transition-colors duration-200 flex items-center gap-2 shrink-0 border ${
                  isSelected
